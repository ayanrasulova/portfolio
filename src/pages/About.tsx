        ...
        <section className = "relative flex flex-col bg-darkerbackground min-h-screen overscroll-none noscroll px-5 sm:px-8 lg:px-16"> 
          <div className="z-10 mt-15 md:mt-32 items-start md:text-left rounded-3xl bg-clip-text pl-0 ml-0"> 
            <div className = "flex flex-col items-center mt-3"> 
              ...
              <br></br>
              <br></br>
              i am extremely passionate about centering accessiblity within all my projects and volunteer work. feel free to reach out to me at <span className ="text-white">ayanfairfax@gmail.com</span> for any questions or inquiries, or reach me at my other socials at the bottom of the page.
              </p>
            </div>
           </div>
        </section>
