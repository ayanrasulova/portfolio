...
const About = () => {
  return (
    <div className = "container mx-auto max-w-7xl">
        ...
        <section className = "relative flex flex-col bg-darkerbackground min-h-screen scroll-auto md:overscroll-none md:noscroll px-5 sm:px-8 lg:px-16"> 
          <div className="z-10 mt-15 md:mt-32 items-start md:text-left rounded-3xl bg-clip-text pl-0 ml-0"> 
            <div className = "flex flex-col items-center mt-3"> 
              ...
              </span> and currently am a <span className = ""> software engineer for uva's </span>{" "}
              ...
              <br></br>
              <br></br>
              asides programming, my hobbies consist of digital art, sewing, graphic design, cutting hair, listening to live music (huge fan of dc emo/hardcore and some goth rock), and playing video games. i am extremely passionate about centering accessiblity within all my projects and volunteer work. feel free to reach out to me at&nbsp;<LinkPreview url="mailto:ayanfairfax@gmail.com" imageSrc = {email}
              ...
              for any questions or inquiries, or any of my other socials at the bottom of the page.
              </p>
            </div>
           </div>
        </section>
